  ...
  render() {
    ...
    return (
      <div>
        <div>
          <p>Recharge USD</p>
          <input value={amountUSD} onChange={this._onChangeUSD} />
          <button onClick={this._rechargeUSD}>Submit</button>
        </div>
        <div>
          <p>Recharge BTC</p>
          <input value={amountBTC} onChange={this._onChangeBTC} />
          <button onClick={this._rechargeBTC}>Submit</button>
        </div>
      </div>
    );
  }
